...
function Landing({ openApp }) {
  return <div className="landing">
    ...
    <main>
      ...
      <section className="preview-wrap"><div className="mini-app"><div className="mini-rail"><div className="mini-logo"><Icon name="bolt" size={16}/></div><i></i><i></i><i></i><b>+</b></div><div className="mini-channels"><strong>NÚCLEO CRIATIVO</strong><p className="active"><Icon name="hash" size={14}/> projeto-alvorada</p><p><Icon name="hash" size={14}/> referências</p><strong>VOZ</strong><p><Icon name="volume" size={14}/> Sala de criação</p></div><div className="mini-chat"><header><Icon name="hash" size={18}/><b>projeto-alvorada</b><span>Um lugar para construir juntos.</span></header><div className="mini-chat-inner"><div className="chat-welcome"><div className="spark"><Icon name="bolt" size={26}/></div><h3>Seu próximo capítulo começa aqui.</h3><p>O canal foi criado. Compartilhe uma ideia para começar.</p></div><div className="bubble-line"><b>Marina Torres</b><p>Acabei de organizar as novas direções visuais.</p></div><div className="bubble-line red"><b>Você</b><p>Incrível. Vamos transformar isso em algo memorável.</p></div></div><div className="mini-input">Escreva uma mensagem... <span>⌘ ↵</span></div></div></div></section>
...
function AppView({ goHome }) {
 ...
 return <div className="app-shell">
  <aside className={'server-rail '+(mobile?'show':'')}><button className="rail-brand" onClick={goHome}><Icon name="bolt" size={19}/></button><div className="rail-line"/><button className="server current">N</button><button className="server cyan">W</button><button className="server purple">A</button><button className="server gold">+</button></aside>
